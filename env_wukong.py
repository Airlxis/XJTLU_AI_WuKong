...
class Wukong(object):
    def __init__(self, observation_w, observation_h, action_dim):
        ...
        self.obs_window = (4,47,1925,1118)

        self.self_blood_window = (210, 1024, 502, 1039)
        self.self_stamina_window = (1698, 991, 2559, 1438)  # 棍势条

        self.boss_blood_window = (767, 955, 1175, 969)
    ...
    #         else:
      #           pass
            ...
            if next_self_stamina - self_stamina >= 7 and action in [0, 2, 4]:
                print(f"奖励：{action} 攻击")
                reward += 1
            ...
            reward = reward + self_blood_reward * 0.5 + \
                boss_blood_reward * 1.8 + self_stamina_reward * 1.0
            done = 0
            emergence_break = 0
            return reward, done, stop, emergence_break
    ...
    def step(self, action, boss_attack):
        ...
        obs = cv2.resize(obs_screen, (self.width, self.height))
